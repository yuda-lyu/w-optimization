...
function main() {
    ...
    //url
    let url = `https://cdn.jsdelivr.net/npm/w-optimization@${pks.version}/dist/w-optimization.umd.js`
    let urlww = `https://cdn.jsdelivr.net/npm/w-optimization@${pks.version}/dist/w-optimization.wk.umd.js`
    ...
    _.each(ltfs, function(v) {
        ...
        //replace
        let r
        r = `../dist/w-optimization.umd.js`
        c = c.replace(r, url)
        r = `../dist/w-optimization.wk.umd.js`
        c = c.replace(r, urlww)
