...
async function rp() {
    ...
    // await rollupWorker({
    //     name: 'WOptimization', //原模組名稱, 將來會掛於winodw下
    ...
    //     fpSrc: path.resolve(fdSrc, 'WOptimization.mjs'), //原始檔案路徑
    //     fpTar: path.resolve(fdTar, 'w-optimization.wk.umd.js'), //檔案輸出路徑
    //     hookNameDist: () => 'w-optimization',
    //     // nameDistType: 'kebabCase',
