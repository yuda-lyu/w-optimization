...
// ============================================================================
// 範例: 用 HS 當「控制器」自適應 ACO 的超參數
//
// 架構:
//   omlACO (被控制) — 透過 funGenerationBefore / funGenerationAfter 兩接口跟外部對話
//   _adapterHS (控制器) — caller 提供 schema 列出要 adapt 的 ACO 超參數
//
// HS 跟 ACO 的對比:
...
async function test() {
    ...
    //HS 要 adapt 的 4 個 ACO 參數 schema (格式同 dps: { name, values })
    let schema = [
