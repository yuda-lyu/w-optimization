...
// ============================================================================
// 範例: 用 TA 當「控制器」自適應 ACO 的超參數
//
// 架構:
//   omlACO (被控制) — 透過 funGenerationBefore / funGenerationAfter 兩接口跟外部對話
//   _adapterTA (控制器) — caller 提供 schema 列出要 adapt 的 ACO 超參數
//
// TA 跟 SA 對比:
...
async function test() {
    ...
    //TA 要 adapt 的 4 個 ACO 參數 schema (格式同 dps: { name, values })
    let schema = [
