...
// ============================================================================
// Benchmark: 比較「無 adapter (omlPSO 預設)」與「4 種 adapter」在 g4 題目之效果
// 每設定跑 N 次取平均
// ============================================================================
...
async function test() {
    ...
    for (let s of scenarios) {
        ...
        let tStart = Date.now()
        for (let i = 0; i < N; i++) {
            let r = await omlPSO(dps, fun, s.build())
            runs.push({
...
//node g4.omlPSO.benchmarkAdapter.mjs
