...
// ============================================================================
// 範例: 用 SA 當「控制器」自適應 PSO 的超參數
//
// 架構:
//   omlPSO (被控制) — 透過 funGenerationBefore / funGenerationAfter 兩接口跟外部對話
//   _adapterSA (控制器) — caller 提供 schema 列出要 adapt 的 PSO 超參數
//
// SA 跟 ACO/HS 的對比:
...
async function test() {
    ...
    //SA 要 adapt 的 5 個 PSO 參數 schema (格式同 dps: { name, values })
    let schema = [
